...
class MealItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return  homeProvider.mealItem.isEmpty
        ? Container(
        child:
        ...
        itemBuilder: (context, index) {
          return Padding(
            ...
            child: cardItem(context: context,
              itemName: homeProvider.mealItem[index].itemName!,
              ...
              iconPressed: () {
                bottomSheet(context,homeProvider.mealItem[index],name: homeProvider.mealItem[index].itemName!);

                print("meal pressed icon");
              },
            ),
          );
        },
        itemCount: homeProvider.mealItem.length,
      ),
    );
  }
}
